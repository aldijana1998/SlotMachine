...
namespace SlotMachine2
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            pictureBox1.Image = Image.FromFile("2.png.png");
            pictureBox2.Image = Image.FromFile("3.png.png");
            pictureBox3.Image = Image.FromFile("1.png.png");
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (credits >= bet)
            {
                ...
                pictureBox1.Image = Image.FromFile(p1.ToString() + ".png.png");

                if (pictureBox2.Image != null) pictureBox2.Image.Dispose();
                pictureBox2.Image = Image.FromFile(p2.ToString() + ".png.png");

                if (pictureBox3.Image != null) pictureBox3.Image.Dispose();
                pictureBox3.Image = Image.FromFile(p3.ToString() + ".png.png");
